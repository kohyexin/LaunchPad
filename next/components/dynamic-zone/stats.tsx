...
export function StatsWithNumberTicker() {
  const items = [
    {
      description:
        "Years in payment business.",
      value: 10,
      subtext: "",
    },
    {
      description: "Countries where payments are processed seamlessly.",
      value: 200,
      subtext: "",
    },
    {
      description:
        "Payment methods integrated worldwide.",
      value: 500,
      subtext: "million",
    },
    {
  ...
  return (
    ...
    <section className="group/container relative mx-auto w-full max-w-7xl overflow-hidden rounded-3xl p-10 py-20">
      <div className="relative z-20">
        ...
        Trusted by Businesses for Seamless Payments and Growth
        </h2>
        <p className="mx-auto mt-4 max-w-2xl text-center text-sm text-neutral-800 dark:text-neutral-200 md:text-base">
        Growing businesses trust Star SaaS to expand seamlessly, accept and send payments in any currency, and boost revenue and customer engagement—all through a single, reliable platform.
        </p>
